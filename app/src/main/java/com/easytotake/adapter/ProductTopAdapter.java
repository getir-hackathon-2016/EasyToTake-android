...
public class ProductTopAdapter extends RecyclerView.Adapter implements RecyclerViewClickListener {
    ...
    public ProductTopAdapter(RecyclerView recyclerView, Context context) {
    ...
    private void loadData() {
        ...
        Call<List<Product>> call = RestClient.getService().topProducts(TAKE);
